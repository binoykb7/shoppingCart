...
public class ShoppingCart {
	...
	public static void main( String[] args ) throws ProductException
   {
	 ...
	 Product p;
	 CartOperationService cartservice = new CartOperationServiceImp(10f);
     System.out.println("------------------------------------------");
	 ...
	 for (int i=1;i<=5;i++) {
	 System.out.println("------------------------------------------");
	 System.out.println("Please enter the details of the product "+i);
	 System.out.println("------------------------------------------");
	 System.out.println("Please enter the name of product ");
	 String name = s.nextLine();
	 System.out.println("Please enter the price of the product ");
	 float price = Float.parseFloat(s.nextLine());
	 System.out.println("Please enter the number of quantity needed  ");
